...
---- Jewelcrafting
	...
	AtlasLoot_Data["AlchemyBattleElixir1"] = {
		...
		{ 25, "s2329", "2454", "=q1=Elixir of Lion's Strength", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["AlchemyPotion1"] = {
		{ 1, "s17580", "13444", "=q1=Major Mana Potion", "=ds="..AL["Vendor"]..", "..BabbleZone["Western Plaguelands"]};
		{ 2, "s17577", "13461", "=q1=Greater Arcane Protection Potion", "=ds="..BabbleZone["Winterspring"]};
		{ 3, "s17574", "13457", "=q1=Greater Fire Protection Potion", "=ds="..BabbleZone["Blackrock Spire"]};
		{ 4, "s17575", "13456", "=q1=Greater Frost Protection Potion", "=ds="..BabbleZone["Winterspring"]};
		{ 5, "s17576", "13458", "=q1=Greater Nature Protection Potion", "=ds="..BabbleZone["Western Plaguelands"]};
		{ 6, "s17578", "13459", "=q1=Greater Shadow Protection Potion", "=ds="..BabbleZone["Eastern Plaguelands"]};
		{ 7, "s24367", "20008", "=q1=Living Action Potion", "=ds="..BabbleFaction["Exalted"]..": "..BabbleFaction["Zandalar Tribe"]};
		{ 8, "s17572", "13462", "=q1=Purification Potion", "=ds="..AL["World Drop"]};
		{ 9, "s17570", "13455", "=q1=Greater Stoneshield Potion", "=ds="..AL["World Drop"]};
		{ 10, "s24366", "20002", "=q1=Greater Dreamless Sleep Potion", "=ds="..BabbleFaction["Friendly"]..": "..BabbleFaction["Zandalar Tribe"]};
		{ 11, "s17556", "13446", "=q1=Major Healing Potion", "=ds="..AL["Trainer"]};
		{ 12, "s17553", "13443", "=q1=Superior Mana Potion", "=ds="..AL["Trainer"]};
		{ 13, "s17552", "13442", "=q1=Mighty Rage Potion", "=ds="..AL["Trainer"]};
		{ 14, "s3175", "3387", "=q1=Limited Invulnerability Potion", "=ds="..AL["World Drop"]};
		{ 15, "s11464", "9172", "=q1=Invisibility Potion", "=ds="..AL["World Drop"]};
		{ 16, "s15833", "12190", "=q1=Dreamless Sleep Potion", "=ds="..AL["Trainer"]};
		{ 17, "s11458", "9144", "=q1=Wildvine Potion", "=ds="..BabbleZone["The Hinterlands"].."/"..BabbleZone["Stranglethorn Vale"]};
		{ 18, "s4942", "4623", "=q1=Lesser Stoneshield Potion", "=ds="..AL["Quest"]..": "..BabbleZone["Badlands"]};
		{ 19, "s11457", "3928", "=q1=Superior Healing Potion", "=ds="..AL["Trainer"]};
		{ 20, "s11453", "9036", "=q1=Magic Resistance Potion", "=ds="..AL["World Drop"]};
		{ 21, "s11452", "9030", "=q1=Restorative Potion", "=ds="..AL["Quest"]..": "..BabbleZone["Badlands"]};
		{ 22, "s11448", "6149", "=q1=Greater Mana Potion", "=ds="..AL["Trainer"]};
		{ 23, "s7258", "6050", "=q1=Frost Protection Potion", "=ds="..AL["Vendor"]};
		{ 24, "s7259", "6052", "=q1=Nature Protection Potion", "=ds="..AL["Vendor"]};
		{ 25, "s6618", "5633", "=q1=Great Rage Potion", "=ds="..AL["Vendor"]};
		{ 26, "s3448", "3823", "=q1=Lesser Invisibility Potion", "=ds="..AL["Trainer"]};
		{ 27, "s7257", "6049", "=q1=Fire Protection Potion", "=ds="..AL["Vendor"]};
		{ 28, "s3452", "3827", "=q1=Mana Potion", "=ds="..AL["Trainer"]};
		{ 29, "s7181", "1710", "=q1=Greater Healing Potion", "=ds="..AL["Trainer"]};
		{ 30, "s6624", "5634", "=q1=Free Action Potion", "=ds="..AL["Vendor"]};
		{ 31, "s7256", "6048", "=q1=Shadow Protection Potion", "=ds="..AL["Vendor"]};
		{ 32, "s3173", "3385", "=q1=Lesser Mana Potion", "=ds="..AL["Trainer"]};
		Next = "AlchemyPotion2";
	...
	AtlasLoot_Data["AlchemyPotion2"] = {
		...
		{ 4, "s7255", "6051", "=q1=Holy Protection Potion", "=ds="..AL["Vendor"]};
		{ 5, "s7841", "6372", "=q1=Swim Speed Potion", "=ds="..AL["Trainer"]};
		{ 6, "s6617", "5631", "=q1=Rage Potion", "=ds="..AL["Vendor"]};
		{ 16, "s2335", "2459", "=q1=Swiftness Potion", "=ds="..AL["World Drop"]};
		{ 17, "s2337", "858", "=q1=Lesser Healing Potion", "=ds="..AL["Trainer"]};
		{ 18, "s4508", "4596", "=q1=Discolored Healing Potion", "=ds="..AL["Quest"]..", "..BabbleZone["Silverpine Forest"]};
		{ 19, "s2332", "2456", "=q1=Minor Rejuvenation Potion", "=ds="..AL["Trainer"]};
		{ 20, "s2331", "2455", "=q1=Minor Mana Potion", "=ds="..AL["Trainer"]};
		{ 21, "s2330", "118", "=q1=Minor Healing Potion", "=ds="..AL["Trainer"]};
		Next = "AlchemyFlask1";
		Prev = "AlchemyPotion1";
		Back = "ALCHEMYMENU";
	};
	...
	AtlasLoot_Data["AlchemyTransmute1"] = {
		...
		{ 21, "s25146", "7068", "=q1=Transmute: Elemental Fire", "=ds="..AL["Vendor"]..", "..BabbleZone["Blackrock Depths"]};
		Next = "AlchemyMisc1";
		Prev = "AlchemyFlask1";
		Back = "ALCHEMYMENU";
	};
	...
	AtlasLoot_Data["AlchemyMisc1"] = {
		...
		{ 2, "s17551", "13423", "=q1=Stonescale Oil", "=ds="..AL["Trainer"]};
		{ 3, "s11473", "9210", "=q1=Ghost Dye", "=ds="..AL["Vendor"]..", "..BabbleZone["Feralas"]};
		...
		{ 7, "s11456", "9061", "=q1=Goblin Rocket Fuel", "=ds="..AL["Crafted"]..": "..GetSpellInfo(4036)};
		{ 8, "s11451", "8956", "=q1=Oil of Immolation", "=ds="..AL["Trainer"]};
		{ 16, "s12609", "10592", "=q1=Catseye Elixir", "=ds="..AL["Trainer"]};
		{ 17, "s3454", "3829", "=q1=Frost Oil", "=ds="..AL["Vendor"]..", "..BabbleZone["Alterac Mountains"]};
		{ 18, "s11459", "9149", "=q1=Philosopher's Stone", "=ds="..AL["Vendor"]..", "..BabbleZone["Tanaris"]};
		{ 19, "s3453", "3828", "=q1=Elixir of Detect Lesser Invisibility", "=ds="..AL["World Drop"]};
		{ 20, "s3449", "3824", "=q1=Shadow Oil", "=ds="..AL["Vendor"]};
	...
	AtlasLoot_Data["SmithingEnhancement1"] = {
		...
		{ 4, "s29729", "23576", "=q1=Greater Ward of Shielding", "=ds=#sr# 375"};
		{ 5, "s32285", "25521", "=q1=Greater Rune of Warding", "=ds=#sr# 350"};
		{ 6, "s29728", "23575", "=q1=Lesser Ward of Shielding", "=ds=#sr# 340"};
		{ 7, "s32284", "23559", "=q1=Lesser Rune of Warding", "=ds=#sr# 325"};
		{ 8, "s29654", "23528", "=q1=Fel Sharpening Stone", "=ds=#sr# 300"};
		{ 9, "s34607", "28420", "=q1=Fel Weightstone", "=ds=#sr# 300"};
		{ 10, "s16641", "12404", "=q1=Dense Sharpening Stone", "=ds=#sr# 250"};
		{ 11, "s16640", "12643", "=q1=Dense Weightstone", "=ds=#sr# 250"};
		{ 16, "s9918", "7964", "=q1=Solid Sharpening Stone", "=ds=#sr# 200"};
		{ 17, "s9921", "7965", "=q1=Solid Weightstone", "=ds=#sr# 200"};
		{ 18, "s7224", "6041", "=q1=Steel Weapon Chain", "=ds=#sr# 190"};
		{ 19, "s7222", "6043", "=q1=Iron Counterweight", "=ds=#sr# 165"};
		{ 20, "s7221", "6042", "=q1=Iron Shield Spike", "=ds=#sr# 150"};
	...
	AtlasLoot_Data["SmithingMisc1"] = {
		...
		{ 9, "s20201", "16206", "=q1=Arcanite Rod", "=ds=#sr# 275"};
		{ 10, "s16639", "12644", "=q1=Dense Grinding Stone", "=ds=#sr# 250"};
		{ 11, "s11454", "9060", "=q1=Inlaid Mithril Cylinder", "=ds=#sr# 200"};
		{ 12, "s14380", "11144", "=q1=Truesilver Rod", "=ds=#sr# 200"};
		{ 13, "s9920", "7966", "=q1=Solid Grinding Stone", "=ds=#sr# 200"};
		{ 14, "s14379", "11128", "=q1=Golden Rod", "=ds=#sr# 150"};
		{ 15, "s8768", "7071", "=q1=Iron Buckle", "=ds=#sr# 150"};
		{ 16, "s3337", "3486", "=q1=Heavy Grinding Stone", "=ds=#sr# 125"};
		{ 17, "s7818", "6338", "=q1=Silver Rod", "=ds=#sr# 100"};
		{ 18, "s3326", "3478", "=q1=Coarse Grinding Stone", "=ds=#sr# 75"};
		{ 19, "s3320", "3470", "=q1=Rough Grinding Stone", "=ds=#sr# 25"};
		Back = "SMITHINGMENU";
	};
